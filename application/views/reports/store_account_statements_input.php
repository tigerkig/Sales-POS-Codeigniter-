				...
				<form class="form-horizontal form-horizontal-mobiles">
					...
					<div id='report_date_range_complex'>
						...
						<div class="form-group">	
							...
							<div class="col-sm-9 col-md-2 col-lg-2">
								<?php echo form_dropdown('pull_payments_by',array('payment_date' => lang('reports_payment_date'), 'sale_date' => lang('common_sale_date')), '', 'id="pull_payments_by" class="form-control"'); ?>
							</div>
						</div>
