		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">				
				...
				<?php if ($data['supplier_info']->email) {?>
					...
					<div class="row">
						<div class="col-md-3 col-xs-12 col-sm-6 ">
						<?php echo anchor("reports/store_account_statements_email_supplier/".$data['supplier_info']->person_id.'/'.$this->uri->segment(4).'/'.$this->uri->segment(5).'/'.$this->uri->segment(6).'/'.$this->uri->segment(7),
