		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				...
				<form  class="form-horizontal form-horizontal-mobiles">
					...
					<?php } ?>
					<div class="form-group">
						<?php echo form_label(lang('reports_supplier').':', 'supplier_input_data', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
						<div class="col-sm-9 col-md-2 col-lg-2">
							
							<?php echo form_input(array(
								'name'=>'supplier_input_data',
								'id'=>'supplier_input_data',
								'size'=>'10',
								'value'=>''));
								?>									
							</div>
						...
						<div class="form-group">
							<?php echo form_label(lang('reports_show_all_items').':', 'show_all_items', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
							<div class="col-sm-9 col-md-2 col-lg-2">
								<?php echo form_checkbox(array(
									'name'=>'show_all_items',
									'id'=>'show_all_items',
									...
									<label for="show_all_items"><span></span></label>
							</div>
						</div>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		$("#generate_report").click(function()
		{
			...
			var show_all_items = $("#show_all_items").prop('checked') ? 1 : 0;
			...
			<?php if (!$hide_excel_export_and_compare) { ?>	
				...
				if ($("#simple_radio").prop('checked'))
				{
					window.location = window.location+'/'+date_range_regular + '/' + do_compare + '/' + date_range_compare + '/' + supplier_id + '/'+ category_id + '/' + sale_type + '/' + show_all_items + '/' + export_excel;
				}
				else
				{
					var start_date = $("#start_date").val();
			...
			<?php } else { ?>
				...
				if ($("#simple_radio").prop('checked'))
				{
					window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + supplier_id + '/'+ category_id + '/' + sale_type + '/' + show_all_items;
				}
				else
				{
					var start_date = $("#start_date").val();
					...
					window.location = window.location+'/'+start_date + '/'+ end_date + '/' + supplier_id + '/' + category_id + '/' + sale_type+ '/'+ show_all_items;
				}
			<?php
			}	
			 ?>
