			...
			<div class="panel-body">
				...
				<form class="form-horizontal form-horizontal-mobiles">
					...
					<div class="form-group">
						...
						<?php echo form_label(lang('reports_show_paid_receivings').':', 'show_paid_receivings', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?> 
						<div class="col-sm-9 col-md-2 col-lg-2">
							<?php echo form_checkbox(array(
								'name'=>'show_paid_receivings',
								'id'=>'show_paid_receivings',
								'value'=>'show_paid_receivings',
								));?>
								<label for="show_paid_receivings"><span></span></label>
							</div>
					</div>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		$("#generate_report").click(function()
		{
			...
			var show_paid_receivings = $("#show_paid_receivings").prop('checked') ? 1 : 0;
			if ($("#export_excel_yes").prop('checked'))
			{
				export_excel = 1;
			}

			window.location = window.location+'/' + specific_id + '/' + show_paid_receivings + '/' + export_excel;
		});	
	});
</script>
